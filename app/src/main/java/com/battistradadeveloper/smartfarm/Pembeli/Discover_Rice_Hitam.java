...
public class Discover_Rice_Hitam extends AppCompatActivity {
	String[] daftar;
	ListView ListView01;
	protected Cursor cursor;
	DataHelper dbcenter;
	public static Discover_Rice_Hitam ma;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_discover__rice__hitam);
	...
	public void RefreshList(){
		...
		cursor = db.rawQuery("SELECT * FROM biodata where jenis ='Beras Hitam'",null);
		...
		ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(Discover_Rice_Hitam.this);
